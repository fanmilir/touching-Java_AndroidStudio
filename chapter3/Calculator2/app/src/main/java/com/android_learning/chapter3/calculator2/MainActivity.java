package com.android_learning.chapter3.calculator2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnMin;    //新增
    private Button btnMul;  //新增
    private Button btnDiv;  //新增
                ...
                if (operatorString.equals("*")) {
                    ...
                    if (operatorString.equals("/")) {
                        ...
                        if (secondNum == 0) {
                            ...
                            float fsecondNum=secondNum ;
                        String result = String.valueOf(firstNum / fsecondNum);
                        tvResult.setText(result);
                    }
                    }
                }
